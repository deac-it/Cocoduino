...
- (void) windowWillClose:(NSNotification *)notification {
    if (self.closeDelegate != nil && [self.closeDelegate respondsToSelector:@selector(preferencesWindowControllerWillClose:)])
        [(id)self.closeDelegate performSelector:@selector(preferencesWindowControllerWillClose:) withObject:self afterDelay:0];
}
