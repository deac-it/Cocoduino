...
- (void)insertSyntaxDefinitions
{
    ...
    /*
     Ignore the analyzer warning, because self.syntaxDefinitionNames is an "assign" property. (This is ugly and should be updated. (But I don't like messing with other's code too much, meh.))
    */
